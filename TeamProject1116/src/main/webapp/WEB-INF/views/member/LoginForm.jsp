            ...
            <div class="loginWrapper">
                <form name="loginInfo" method="post" action="MemberLoginAction" onsubmit="return checkValue()">
                    ...
                    <tr>   
                        ...
                        <input class="form-control login" type="text" name="id" placeholder="아이디를 입력하세요" style="font-size: 12px">  
                        </div> 
                        <td>
                    </tr>
                    <tr>  
                        ...
                        <input class="form-control pw" type="password"  name="password"  placeholder="비밀번호를 입력하세요" style="font-size: 12px">  
                        </div>
                        </td>
                    </tr>
                    <tr> 
                        ...
                        <div class="form-check" style="font-size:12px">
                            <input type="checkbox" class="form-check-input" id="keepLogin" name="keepLogin" value="true">
                            <label class="form-check-label" for="exampleCheck1">자동로그인</label>
                            <div class="find"><a href="IdCheckForm">아이디 찾기 </a> | <a href="EmailCheckForm">비밀번호 찾기</a></div>
                        </div>  
                         </td>
                    </tr>
                    <tr> 
                    <td>
	                    ...
	                    <button type="button" class="join_btn" onclick="return goJoinForm()">회원가입</button> 
                    </div>
                    </td> 
                    </tr>
                </table>
