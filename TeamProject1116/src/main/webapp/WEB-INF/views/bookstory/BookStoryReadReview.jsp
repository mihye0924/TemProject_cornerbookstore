...
<jsp:include page="/WEB-INF/views/BookStoryMainHeader.jsp"/>
     ...
     <div id="main">
             ...
             <section>  
              		<div class="all_view"><span>책읽고,리뷰남기기</span></div>
             	<div class="hr3"></div> 
                  ...
                  <!-- 페이징처리 -->
          	      <nav aria-label="Page navigation example ">
				  	<ul class="pagination  justify-content-center ">
					  	<li class="page-item">
					    	<a class="page-link"  href="BookStoryReadReview?page=1">1</a>
					    </li>
					  	<li class="page-item">
					      	<a class="page-link" href="BookStoryReadReview?page=2">2</a>
					    </li>
					    <li class="page-item">
					    	<a class="page-link" href="BookStoryReadReview?page=3">3</a>
					    </li>
					      <li class="page-item">
					    	<a class="page-link" href="BookStoryReadReview?page=4">4</a>
					    </li>  
			  		</ul>
				  </nav>
            </section>
